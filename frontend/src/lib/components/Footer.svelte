...
<footer class="bg-white dark:bg-gray-900 pt-20 lg:pt-[120px] pb-10 lg:pb-20 relative z-10">
    <div class="container">
       <div class="flex flex-wrap -mx-4">
          <div class="w-full sm:w-2/3 lg:w-3/12 px-4">
             <div class="w-full mb-10">
                ...
                <p class="flex items-center text-sm text-dark font-medium">
                   ...
                   <span class="text-[#637381]">+012 (345) 678 99</span>
                </p>
             </div>
          </div>
          <div class="w-full sm:w-1/2 lg:w-2/12 px-4">
             <div class="w-full mb-10">
                <h4 class="text-dark dark:text-red-700 text-lg font-semibold mb-9">Resources</h4>
                <ul>
                   <li>
                      <a
                         href="javascript:void(0)"
          ...
          <div class="w-full sm:w-1/2 lg:w-2/12 px-4">
             <div class="w-full mb-10">
                <h4 class="text-dark dark:text-red-700 text-lg font-semibold mb-9">Company</h4>
                <ul>
                   <li>
                      <a
                         href="javascript:void(0)"
          ...
          <div class="w-full sm:w-1/2 lg:w-2/12 px-4">
             <div class="w-full mb-10">
                <h4 class="text-dark dark:text-red-700 text-lg font-semibold mb-9">Quick Links</h4>
                <ul>
                   <li>
                      <a
                         href="javascript:void(0)"
          ...
          <div class="w-full sm:w-1/2 lg:w-3/12 px-4">
             <div class="w-full mb-10">
                <h4 class="text-dark dark:text-red-700 text-lg font-semibold mb-9">Follow Us On</h4>
